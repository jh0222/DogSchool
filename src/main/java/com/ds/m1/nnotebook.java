...
public class nnotebook {
	...
	public nnotebook(int mp_no, String mp_title, String mp_condition, int mp_meal, int mp_defecate, String mp_supplies,
			String mp_txt, String mp_tid, String mp_uid, String mp_uname, Date mp_date) {
		super();
		this.mp_no = mp_no;
