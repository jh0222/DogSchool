...
<form action="T_mypageUpdateC" name ="myForm" onsubmit="return call()"method="post">
		<div class="textForm">
			아이디
		...
		<div class="textForm">
			휴대전화번호</br>
			<c:choose>
				<c:when test="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 0, 3) eq '010'}">
				...
				<c:when test="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 0, 3) eq '011'}">
					<select name="phonefirst">
				...
				<c:when test="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 0, 3) eq '016'}">
					<select name="phonefirst">
		   				<option value="010">010</option>
		   				<option value="011">011</option>
				...
				<c:when test="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 0, 3) eq '017'}">
					<select name="phonefirst">
		   				<option value="010">010</option>
		   				<option value="011">011</option>
		   				<option value="016">016</option>
				...
				<c:when test="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 0, 3) eq '018'}">
					<select name="phonefirst">
		   				<option value="010">010</option>
		   				<option value="011">011</option>
		   				<option value="016">016</option>
			...
			-
			<input name="phonesecond"class="phonenumber" maxlength='4' value="<c:out value="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 3, 7)}"></c:out>">
			-
			<input name="phonethird"class="phonenumber" maxlength='4' value="<c:out value="${fn:substring(sessionScope.taccountInfo.t_phonenumber, 7, 11)}"></c:out>">
		</div>
		<div class="textForm">
			성 별
